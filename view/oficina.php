                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <input class="form-control " type="text" placeholder="Nombre" maxlength="100" id="nombre_oficina" name="nombre_oficina" required>
                                                        </div>
                                                        <br></br>
                                                        <br></br>
                                                        <label for="example-text-input" class="col-sm-2 col-form-label">Direccion</label>
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" placeholder="Direccion" maxlength="100" id="direccion_oficina" name="direccion_oficina" required>
                                                        </div>
                                                    </div> 
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select id="correo_personal" name="correo" class="form-control" data-live-search="true" required>
                                                            </select>
                                                        </div>
                                                    </div> 
                                                </div>
...
<script type="text/javascript" src="script/oficina.js"></script>    
<?php 
